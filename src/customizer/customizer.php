...
add_filter( 'genesis_customizer_sections', __NAMESPACE__ . '\hero_image_fields', 20, 1 );
/**
 * Description of expected behavior.
 *
 * @since 1.0.0
 ...
 * @return void
 */
function hero_image_fields( $sections ) {
	...
	foreach ( $taxonomies as $taxonomy => $title ) {
		...
		$new_sections['hero'][ $taxonomy ] = $title . __( ' Images', 'genesis-customizer' );
